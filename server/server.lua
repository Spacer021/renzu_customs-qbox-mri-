...
function Jobmoney(job, xPlayer)
    ...
    if Config.UseRenzu_jobs then
        ...
        if Config.framework == 'ESX' then
            ...
            -- Usando o ps-banking para obter o dinheiro da sociedade
            value = exports['ps-banking']:GetAccountBalance(job) -- Função do ps-banking para obter o saldo da conta da sociedade
        end
...
function Society(job, amount, method)
    if Config.framework == 'ESX' then
        TriggerEvent('esx_addonaccount:getSharedAccount', 'society_'..job, function(account)
        ...
        -- Usando o ps-banking para manipular o dinheiro da sociedade
        if method == 'remove' then
            exports['ps-banking']:RemoveMoney(job, amount, 'Pagamento de serviço') -- Remove dinheiro da conta da sociedade
        else
            exports['ps-banking']:AddMoney(job, amount, 'Recebimento de serviço') -- Adiciona dinheiro à conta da sociedade
        end
    end
end
